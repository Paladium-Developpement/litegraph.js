(function (global) {
     ...
     * @param {Array} nodes_list a list with all the nodes to search from, by default is all the
     *     nodes in the graph
...
*/
    ...
    // LGraphNode.prototype.deserialize = function(info) {} //this cannot be done from within, must
